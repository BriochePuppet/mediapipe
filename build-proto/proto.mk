...
all : \
	...
	$(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.pb.h \
	$(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.pb.cc \
	...
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.pb.h \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.pb.cc \
	...
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.pb.h \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.pb.cc \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.pb.h \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.pb.cc \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.pb.h \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.pb.cc \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.pb.h \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.pb.cc \
...
$(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.pb.h $(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.pb.cc $(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.d : $(PROTO_SOURCE_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.proto
	$(HIDE) $(call host-mkdir,$(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util)
	$(HIDE) "$(PROTO_COMPILER_PATH)" "-I$(PROTO_SOURCE_DIR)" "-I$(PROTO_SYSTEM_INCLUDE_DIR)" "--dependency_out=$(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.d" "--cpp_out=$(PROTO_CPP_OUT_DIR)" "$(PROTO_SOURCE_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.proto"
...
$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.pb.h $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.pb.cc $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.d : $(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.proto
	$(HIDE) $(call host-mkdir,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto)
	$(HIDE) "$(PROTO_COMPILER_PATH)" "-I$(PROTO_SOURCE_DIR)" "-I$(PROTO_SYSTEM_INCLUDE_DIR)" "--dependency_out=$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.d" "--cpp_out=$(PROTO_CPP_OUT_DIR)" "$(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.proto"
...
$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.pb.h $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.pb.cc $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.d : $(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.proto
	$(HIDE) $(call host-mkdir,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto)
	$(HIDE) "$(PROTO_COMPILER_PATH)" "-I$(PROTO_SOURCE_DIR)" "-I$(PROTO_SYSTEM_INCLUDE_DIR)" "--dependency_out=$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.d" "--cpp_out=$(PROTO_CPP_OUT_DIR)" "$(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.proto"	

$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.pb.h $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.pb.cc $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/hand_landmarker/calculators/hand_association_calculator.d : $(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.proto
	$(HIDE) $(call host-mkdir,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators)
	$(HIDE) "$(PROTO_COMPILER_PATH)" "-I$(PROTO_SOURCE_DIR)" "-I$(PROTO_SYSTEM_INCLUDE_DIR)" "--dependency_out=$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.d" "--cpp_out=$(PROTO_CPP_OUT_DIR)" "$(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.proto"	

$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.pb.h $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.pb.cc $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/hand_landmarker/proto/hand_landmarker_graph_options.d : $(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.proto
	$(HIDE) $(call host-mkdir,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto)
	$(HIDE) "$(PROTO_COMPILER_PATH)" "-I$(PROTO_SOURCE_DIR)" "-I$(PROTO_SYSTEM_INCLUDE_DIR)" "--dependency_out=$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.d" "--cpp_out=$(PROTO_CPP_OUT_DIR)" "$(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.proto"	

$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.pb.h $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.pb.cc $(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/hand_landmarker/proto/hand_landmarks_detector_graph_options.d : $(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.proto
	$(HIDE) $(call host-mkdir,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto)
	$(HIDE) "$(PROTO_COMPILER_PATH)" "-I$(PROTO_SOURCE_DIR)" "-I$(PROTO_SYSTEM_INCLUDE_DIR)" "--dependency_out=$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.d" "--cpp_out=$(PROTO_CPP_OUT_DIR)" "$(PROTO_SOURCE_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.proto"	
...
-include \
	...
	$(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.d \
	...
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.d \
	...
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.d \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.d \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.d \
	$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.d \
...
clean:
	...
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.pb.h)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.pb.cc)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/calculators/util/detection_label_id_to_text_calculator.d)
	...
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.pb.h)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.pb.cc)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/components/processors/proto/classifier_options.d)
	...
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.pb.h)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.pb.cc)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_detector/proto/hand_detector_graph_options.d)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.pb.h)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculator.pb.cc)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/calculators/hand_association_calculators.d)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.pb.h)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.pb.cc)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarker_graph_options.d)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.pb.h)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.pb.cc)
	$(HIDE) $(call host-rm,$(PROTO_CPP_OUT_DIR)/mediapipe/tasks/cc/vision/hand_landmarker/proto/hand_landmarks_detector_graph_options.d)
